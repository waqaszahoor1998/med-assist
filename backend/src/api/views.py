...
from .models import Medicine, UserProfile, MedicationReminder, PrescriptionHistory
...
def search_medical_knowledge(request):
    ...
    return db_search_knowledge(request)
...
def get_medical_explanation(request, medicine_name):
    ...
    return db_get_explanation(request, medicine_name)
